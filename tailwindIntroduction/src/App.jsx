...
function App() {
  ...
  return (
    <>
     <h1 className=" font-bold , bg-yellow-600 , "> Vansh Wears</h1>

     <div className="flex font-serif , bg-white">
  <div className="flex-none w-52 relative  ">
    <img src="/vanshpic.png" alt="" className=" absolute inset-0 w-50% h-50% object-cover rounded-lg" loading="lazy" />
  </div>
